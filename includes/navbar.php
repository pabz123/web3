...
<head>
    ...
    <link rel="preload" href="/js/websocket-client.js" as="script">
  ...
  <div class="nav-links">
    ...
    <div class="header-actions">
      <?php if (!empty($_SESSION['user'])): ?>
        <img id="user-avatar" src="<?= htmlspecialchars($_SESSION['user']['profile_image'] ?? '/uploads/profile/default-avatar.png') ?>" alt="Profile" class="profile-avatar-small">
        ...
        <div class="dropdown-menu" id="dropdown-menu">
          ...
          <?php if (($_SESSION['user']['role'] ?? '') === 'employer'): ?>
            <a href="employer-profile.php">🏢 Company Profile</a>

  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    if (logoutBtn) {
      logoutBtn.addEventListener("click", async (e) => {
        ...
        // try server logout if you have a route; ignore errors
        try {
          // adjust endpoint path if your logout is at /includes/logout.php or /api/auth/logout.php
          await fetch("/includes/logout.php", { method: "POST", credentials: "include" });
        } catch (err) {
